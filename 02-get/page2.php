...
// **********************************
// $_GET represente l url : il s agit d une superglobale d un ARRAY; supergloble signifie qu il est disponibe dans tous les contexte du script, y compris dans les fonctions
...
echo 'Prix : ' . $_GET['prix'] . '<br>';
    ...
    echo 'Aucun articles selectionne';
}